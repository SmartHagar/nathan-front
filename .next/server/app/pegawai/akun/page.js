...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 15358)), "/media/smarthagar/Assets/Project/NextJS/TA/nathan-front/src/app/pegawai/akun/page.tsx"],
    ...
    const pages = ["/media/smarthagar/Assets/Project/NextJS/TA/nathan-front/src/app/pegawai/akun/page.tsx"];
    
    const originalPathname = "/pegawai/akun/page"
    const __next_app__ = {
...
;// CONCATENATED MODULE: ./src/app/pegawai/akun/form/BodyForm.tsx
/** @format */ /* __next_internal_client_entry_do_not_use__ default auto */ 



const BodyForm = ({ register, errors, control, watch, setValue, dtLogin })=>{
...
;// CONCATENATED MODULE: ./src/app/pegawai/akun/form/Form.tsx
/** @format */ /* __next_internal_client_entry_do_not_use__ default auto */ 
...
const Form = ({})=>{
    // store
    const { cekToken, dtLogin } = (0,login/* default */.Z)();
    (0,react_.useEffect)(()=>{
        cekToken();
        return ()=>{};
    }, [
    ...
    // store
    const { setUpdate } = (0,login/* default */.Z)();
    const formSchema = node_modules_yup/* object */.Ry().shape({
        password: node_modules_yup/* string */.Z_().min(3, "Password harus lebih dari 3 karakter"),
        confirmPwd: node_modules_yup/* string */.Z_().oneOf([
            node_modules_yup/* ref */.iH("password")
        ], "Konfirmasi Password tidak sama"),
        email: node_modules_yup/* string */.Z_().email("Email tidak valid")
    });
    // hook form
    const { register, handleSubmit, setValue, control, formState: { errors }, watch } = (0,index_esm/* useForm */.cI)({
        resolver: (0,yup/* yupResolver */.X)(formSchema)
    });
    const resetForm = ()=>{
...
const proxy = (0,module_proxy.createProxy)(String.raw`/media/smarthagar/Assets/Project/NextJS/TA/nathan-front/src/app/pegawai/akun/form/Form.tsx`)
...
var dist = __webpack_require__(8167);
;// CONCATENATED MODULE: ./src/app/pegawai/akun/page.tsx
/** @format */ 
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx("p", {
                    children: "Silahkan mengubah data akun anda pada form dibawah ini. Masukanlah email dan password yang baru jika anda ingin mengubahnya."
                })
            }),
...
/* harmony default export */ const page = (Akun);
...
var __webpack_exports__ = __webpack_require__.X(0, [1697,6601,7947,1621,1031,429,7515,6166,3702,2491,9269,7873,6961], () => (__webpack_exec__(40868)));
