...
const toastShow = ({ event, position })=>{
    switch(event.type){
        case "success":
            react_hot_toast__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .ZP.success(event.message, {
                duration: 4000,
                position
            });
            break;
        case "error":
            react_hot_toast__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .ZP.error(event.message, {
                duration: 4000,
                position
            });
            break;
